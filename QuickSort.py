...
def getColorArray(dataLength, low, high, border, currentIndex, isSwaping = False):
    ...
    for i in range(dataLength):
        ...
        if i >= low and i <= high:
            ...
            colorArray.append('#FAF7F0') # All other elements we aren't currently looking at; outside of range(low, high+1)
        ...
        if isSwaping:
            if i == border or i == currentIndex:
                colorArray[i] = '#BCCEF8' # Element is highlighted in purple if it has been swapped / sorted
