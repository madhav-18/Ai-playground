...
<p align="center">
  ...
  <p align="center">
  <i><b>A desktop app made using Tkinter and Pygame modules of Python to visualize different computer algorithms like searching, sorting and backtracking etc.
  This project's main motive is to help beginners to understand the basic idea of common algorithms. <br/>
  More algorithms and sounds will be added to improve the users' overall experience and make this app more user friendly.<br/>
    </i>
  </p>
</p>
